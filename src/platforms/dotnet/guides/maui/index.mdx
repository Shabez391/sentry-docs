...
- Easy nimmye integration by calling `UseSentry` on your `MauiAppBuilder`
...
The `Sentry.nimmye` SDK is currently in public preview.  All APIs added by this package are subject to breaking changes.  We appreciate your feedback:
